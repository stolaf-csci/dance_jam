...
An **algorithm** is just a <u>set of clear instructions</u> that tell you how to accomplish a particular task. If you've ever followed a recipe or built IKEA furniture, you've used an algorithm before!
...
![Prof Kim's animation for Bubble Sort that she can teach you how to make using the manim Python library](files/BubbleSort.mp4)  
