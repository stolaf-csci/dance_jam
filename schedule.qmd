...
| Week | Topic                       | Weekday   | Date | Lecture                                        | Standards           | Assignments (due at midnight) |
|:------:|:-----------------------------:|:-----------:|:------:|:------------------------------------------------:|:---------------------:|:-------------------------------:|
| 1    | First Day                   | Friday    | 2/7  | Welcome + Programming [IRL](slides/IRL.pdf)                      |                     |                               |
| 2    | IO: Input and Output        | Monday    | 2/10 | [IO1](slides/IO1.pdf): Inside Computers, Algorithms, print()     |                     | RR1, About Me quiz            |
| 2    | IO: Input and Output        | Wednesday | 2/12 | [IO2](slides/IO2.pdf): Variables, Operators, Data Types, input() |                     |                               |
...
| 14   | CLS: Classes                | Wednesday | 5/7  | Workday                                        | Quiz 6 rewrites due | HW11                          |
